...
//   // NOUVEAU: États pour le calcul des gains journaliers
...
//   useEffect(() => {
//     loadUsers();
//     loadLastCalculation(); // NOUVEAU: Charger le dernier calcul
//   }, []);

//   // NOUVEAU: Charger le dernier calcul des gains
...
//           totalInvested: walletData.stats?.totalInvested || 0,
//           totalWithdrawn: walletData.stats?.totalWithdrawn || 0,
//           lastDailyGainAt: walletData.stats?.lastDailyGainAt?.toDate?.() || null, // NOUVEAU
//           totalDailyGains: walletData.stats?.totalDailyGains || 0, // NOUVEAU
...
//   // NOUVEAU: Fonction pour télécharger le rapport
