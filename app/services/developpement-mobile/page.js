...
export default function DeveloppementWebPage() {
  let title = "création d’applications mobiles Android & iOS"
  let content= " Faites développer votre application mobile fluide, intuitive et 100% personnalisée."
  let  image ="/mobile.jpg"
    return (
      <>
